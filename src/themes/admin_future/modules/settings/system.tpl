            ...
            <div class="collapse show" id="collapse-cache">
                <div class="card card-body">
                    ...
                    <div class="row mb-3 redis-settings">
                        ...
                        <div class="col-sm-8 col-lg-6 col-xxl-5">
                            <input type="password" class="form-control" id="element_redis_password" name="redis_password" value="{if !empty($DATA.redis_password)}{$CRYPT->decrypt($DATA.redis_password)}{/if}">
